...
class CreateClientUseCaseTest {
    @Test
    void createAClient(){
        var command = new AddClient(ClientId.of("678"), new ClientName("Andrés"), new ClientAdress("Calle 34 CC #89-28"), new ClientEmailAdress("andresanchez200319@gmail.com"), new ClientTelephone("3172185125"));
